...
public class OrderService {
    ...
    public OrderService(OrderRepository orderRepository, MenuItemRepository menuItemRepository,
            RestaurantTableRepository tableRepository, StaffMemberRepository staffRepository,
    ...
    public Order create(CreateOrderRequest request) {
        ...
        if (request.waiterId() != null) {
            StaffMember waiter = staffRepository.findById(request.waiterId())
                    .orElseThrow(() -> NotFoundException.of("StaffMember", request.waiterId()));
    ...
    public Order removeItem(UUID orderId, UUID itemId) {
        ...
        if (!removed) {
            throw NotFoundException.of("OrderItem", itemId);
        }
        order.recalculateTotal();
        return publish(orderRepository.save(order));
    }
